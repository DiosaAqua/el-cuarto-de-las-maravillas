...
export default async function Slider() {
  ...
  return (
    <>
      ...
      <p className="sub">Las imágenes se cargan en la sección Imágenes; acá pegás la ruta.</p>
        ...
        {slides.map((s, i) => (
          <fieldset className="fs" key={s.id}>
            ...
            <div className="grid2">
              ...
              <Text label="Imagen" name="image" defaultValue={s.image} hint="/uploads/…" />
            ...
            <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: '1fr 190px', gap: 20, alignItems: 'start' }}>
              <Area label="Texto" name="copy" defaultValue={s.copy} style={{ minHeight: 80 }} />
              <img src={s.image} alt="" style={{ width: '100%', aspectRatio: '16/10', objectFit: 'cover', background: 'var(--surface)' }} />
            </div>
          </fieldset>
        ))}
